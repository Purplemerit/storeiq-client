...
import MemeGenerator from "./pages/dashboard/create-video/MemeGenerator";
import ThumbnailGenerator from "./pages/dashboard/create-video/ThumbnailGenerator";
